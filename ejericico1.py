...
Original file is located at
    https://colab.research.google.com/drive/1lJv4pyjMFY_N2pivRN7c81IJ4Fyy3v-8
"""
...
def lagrange_interpolation(x, x_puntos, y_puntos):
    P_Interpolacion = len(x_puntos)
    Resultado = 0
    for Iteracion_i in range(P_Interpolacion):
        termino_Lag = y_puntos[Iteracion_i]
...
#Gráficas de errores
g, ax = plt.subplots(1, 2, figsize=(14, 5))
